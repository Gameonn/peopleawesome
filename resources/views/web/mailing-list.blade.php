...
<div class="container">
      ...
      {!! Form::open(array('url' => 'add-mailing-list', 'method' => 'post', 'id' => 'video-upload-form', 'class'=>'form-horizontal' )) !!}
      ...
      <fieldset>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                              ...
                              <select name="country" class="form-control" id="mce-MMERGE1">
            ...
            <div class="form-group align-center terms-line">
                  By submitting my details, I accept Check this Out's <a href="{{ URL::to('/') }}/terms-conditions" class="" target="_blank">Terms of Service</a> and <a href="{{ URL::to('/') }}/privacy-policy" class="" target="_blank">Privacy Policy </a>
            </div>

            <div class="form-group">
                  <label class="col-md-4 control-label"></label>
                  <div class="col-md-4">
                        <button type="submit" class="btn btn-warning">Subscribe <span class="fa fa-paper-plane"></span></button>
                  </div>
            </div>
